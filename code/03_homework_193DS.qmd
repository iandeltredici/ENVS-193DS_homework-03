...
#| message: false
ggplot(data = salinity, #create plot with salinity dateframe
...
To evaluate the strength of the relationship between pickleweed biomass and soil salinity, I used a Pearson correlation which found a moderate relationship between the two variables (Pearson's r = 0.53, t(21)= 2.90), p = 0.009, $\alpha$  = 0.05). Therefore pickleweed biomass and soil salinity are 53% correlated in a positive direction. 
